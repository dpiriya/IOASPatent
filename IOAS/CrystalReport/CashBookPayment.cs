...
namespace IOAS.CrystalReport {
    ...
    public class CashBookPayment : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IOAS.CrystalReport.CashBookPayment.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCashBookPayment : Component, ICachedReport {
        
        public CachedCashBookPayment() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CashBookPayment rpt = new CashBookPayment();
            rpt.Site = this.Site;
            return rpt;
        }
